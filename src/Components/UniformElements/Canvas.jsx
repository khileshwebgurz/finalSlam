...
export default function Canvas({ selectedNeckImage, selectedShoulderImage ,selectedCutorNoCut}) {
...
useEffect(() => {
  ...
  useEffect(() => {
    if (selectedShoulderImage) {
      if ((value === 2 || value === 3) &&
        (selectedShoulderImage.frontassociate || selectedShoulderImage.backassociate)
      ) {
        setValue(0);
      }
    }
    ...
    <>
      <div className="customize-view ">
        <div id="scroll_change" className="customize-view__inner">
          <div className="customize-view__wrap flex-row">
      ...
      >
        ...
        >
          <Tab
            style={{ minHeight: 100 }}
            icon={
              <Avatar style={{ minHeight: 100, minWidth: 70 }} src={front} />
            }
            {...a11yProps(0)}
          />
          <Tab
            style={{ minHeight: 100 }}
            icon={
              <Avatar style={{ minHeight: 100, minWidth: 70 }} src={back} />
            }
            {...a11yProps(1)}
          />
          <Tab
            style={{ minHeight: 100 }}
            icon={
              <Avatar style={{ minHeight: 100, minWidth: 70 }} src={left} />
            }
            {...a11yProps(2)}
          />
        <Tab
