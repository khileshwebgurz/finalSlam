...
// import JerseyStore from "./UniformStore/JerseyStore.jsx";
// import CustomizeUniform from "./CustomizeUniform.jsx";
import CanvasStore  from "./UniformStore/CanvasStore.jsx"
                ...
                <li key={jerseyPreviewItem.id}>
                  <a onClick={() => handleClick(jerseyPreviewItem.id)}>
                    <div className="uniform-details new">
                      ...
                      <div className="uniform-tag">N{jerseyPreviewItem.id}</div>
                    </div>
                  </a>
                </li>
              ))}
